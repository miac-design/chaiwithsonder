export const menteeFaqs = [
  {
    q: 'How do I find the right mentor on ChaiChat?',
    a: 'Browse our mentor directory and filter by expertise, industry, and availability. Each mentor profile shows their background, specialties, and open time slots so you can find someone who aligns with your goals.',
  },
  {
  ...
  },
  {
    ...
    a: "That's exactly why ChaiChat was built. Our founder came to the US as a PhD student with no network. Many of our mentors are immigrants, career changers, and first-generation professionals who understand what it's like to start from scratch.",
  },
  {
    q: "Can I switch mentors if it's not the right fit?",
    a: "Of course. Finding the right mentor is a journey. You're welcome to explore different mentors until you find the connection that feels right.",
  },
];
...
export const mentorFaqs = [
  ...
  },
  {
    ...
    a: "Yes. You have full control over which mentee requests you accept. You can review each mentee's background and goals before committing to a session.",
  },
  {
